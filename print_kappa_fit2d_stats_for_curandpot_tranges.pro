...
PRO PRINT_KAPPA_FIT2D_STATS_FOR_CURANDPOT_TRANGES,fit2DK,fit2DG,cAP_struct,jvPlotData, $
  ...
  IF (nfit2DInds EQ 0) OR (njvPlotInds EQ 0) THEN RETURN
...
;; inds = [0:102] & PRINT,FORMAT='("pots={",103(F-8.3,:,","),"}")',jvPlotData.pot[inds] & PRINT,FORMAT='("cur={",103(F-8.3,:,","),"}")',jvPlotData.cur[inds]*(-1.D) & PRINT,FORMAT='("curErrs={",103(F-8.3,:,","),"}")',jvPlotData.curErr[inds]
  ...
  maxJVPlotInd = N_ELEMENTS(jvPlotInds)-1
  maxfit2DKInd = N_ELEMENTS(fit2DK.fitparams[0,*])-1
  maxfit2DGInd = N_ELEMENTS(fit2DG.fitparams[0,*])-1
  maxfit2DKSDTInd = N_ELEMENTS(fit2DK.sdt)-1
  FOR k=0,nfit2DInds-1 DO BEGIN
     tmpInd = fit2DInds[k]
     tmpKVal = fit2DK.fitparams[*,(tmpInd < maxfit2DKInd)]
     tmpGVal = fit2DG.fitparams[*,(tmpInd < maxfit2DGInd)]
     PRINT,FORMAT='(I0,T5,A0,T30,F-8.1,T40,F-8.1,T50,F-8.1,T60,F-8.3,T70,F-8.4,T80,F-8.1,T90,F-8.1,T100,I-8,T110,F-8.4)', $
           k, $
           TIME_TO_STR(fit2DK.sdt[(tmpInd < maxfit2DKSDTInd)].time,/MS), $
           jvPlotData.pot[jvPlotInds[(k < maxJVPlotInd)]], $
           tmpKVal[0], $
           tmpKVal[1], $
           tmpKVal[2], $
           tmpKVal[3], $
  ...
  PRINT,FORMAT='(A0,T30,F-8.1,T40,F-8.1,T50,F-8.1,T60,F-8.3,T70,F-8.4,T80,F-8.1,T90,F-8.1,T100,I-8,T110,F-8.4)', $
        "AVG", $
        MEAN(jvPlotData.pot[(jvPlotInds < maxJVPlotInd)]), $
        MEAN(fit2DK.fitparams[0,(fit2DInds < maxfit2DKInd)]), $
        MEAN(fit2DK.fitparams[1,(fit2DInds < maxfit2DKInd)]), $
        MEAN(fit2DK.fitparams[2,(fit2DInds < maxfit2DKInd)]), $
        MEAN(fit2DK.fitparams[3,(fit2DInds < maxfit2DKInd)]), $
        MEAN(fit2DG.fitparams[0,(fit2DInds < maxfit2DGInd)]), $
        MEAN(fit2DG.fitparams[1,(fit2DInds < maxfit2DGInd)]), $
        MEAN(fit2DG.fitparams[2,(fit2DInds < maxfit2DGInd)]), $
        MEAN(fit2DG.fitparams[3,(fit2DInds < maxfit2DGInd)])
  ;; PRINT,FORMAT='(A0,T30,F-8.1,T40,F-8.1,T50,F-8.3,T60,F-8.4,T70,F-8.1,T80,F-8.1,T90,I-8,T100,F-8.4)', $
  PRINT,FORMAT='(A0,T30,F-8.1,T40,F-8.1,T50,F-8.1,T60,F-8.3,T70,F-8.4,T80,F-8.1,T90,F-8.1,T100,I-8,T110,F-8.4)', $
        "MEDIAN", $
        MEDIAN(jvPlotData.pot[(jvPlotInds < maxJVPlotInd)]), $
        MEDIAN(fit2DK.fitparams[0,(fit2DInds < maxfit2DKInd)]), $
        MEDIAN(fit2DK.fitparams[1,(fit2DInds < maxfit2DKInd)]), $
        MEDIAN(fit2DK.fitparams[2,(fit2DInds < maxfit2DKInd)]), $
        MEDIAN(fit2DK.fitparams[3,(fit2DInds < maxfit2DKInd)]), $
        MEDIAN(fit2DG.fitparams[0,(fit2DInds < maxfit2DGInd)]), $
        MEDIAN(fit2DG.fitparams[1,(fit2DInds < maxfit2DGInd)]), $
        MEDIAN(fit2DG.fitparams[2,(fit2DInds < maxfit2DGInd)]), $
        MEDIAN(fit2DG.fitparams[3,(fit2DInds < maxfit2DGInd)])
  ;; PRINT,FORMAT='(A0,T30,F-8.1,T40,F-8.1,T50,F-8.3,T60,F-8.4,T70,F-8.1,T80,F-8.1,T90,I-8,T100,F-8.4)', $
  PRINT,FORMAT='(A0,T30,F-8.1,T40,F-8.1,T50,F-8.1,T60,F-8.3,T70,F-8.4,T80,F-8.1,T90,F-8.1,T100,I-8,T110,F-8.4)', $
        "STDDEV", $
        STDDEV(jvPlotData.pot[(jvPlotInds < maxJVPlotInd)]), $
        STDDEV(fit2DK.fitparams[0,(fit2DInds < maxfit2DKInd)]), $
        STDDEV(fit2DK.fitparams[1,(fit2DInds < maxfit2DKInd)]), $
        STDDEV(fit2DK.fitparams[2,(fit2DInds < maxfit2DKInd)]), $
        STDDEV(fit2DK.fitparams[3,(fit2DInds < maxfit2DKInd)]), $
        STDDEV(fit2DG.fitparams[0,(fit2DInds < maxfit2DGInd)]), $
        STDDEV(fit2DG.fitparams[1,(fit2DInds < maxfit2DGInd)]), $
        STDDEV(fit2DG.fitparams[2,(fit2DInds < maxfit2DGInd)]), $
        STDDEV(fit2DG.fitparams[3,(fit2DInds < maxfit2DGInd)])
  PRINT,FORMAT='(A0,T30,F-8.1,T40,F-8.1,T50,F-8.1,T60,F-8.3,T70,F-8.4,T80,F-8.1,T90,F-8.1,T100,I-8,T110,F-8.4)', $
        "MIN", $
        MIN(jvPlotData.pot[(jvPlotInds < maxJVPlotInd)]), $
        MIN(fit2DK.fitparams[0,(fit2DInds < maxfit2DKInd)]), $
        MIN(fit2DK.fitparams[1,(fit2DInds < maxfit2DKInd)]), $
        MIN(fit2DK.fitparams[2,(fit2DInds < maxfit2DKInd)]), $
        MIN(fit2DK.fitparams[3,(fit2DInds < maxfit2DKInd)]), $
        MIN(fit2DG.fitparams[0,(fit2DInds < maxfit2DGInd)]), $
        MIN(fit2DG.fitparams[1,(fit2DInds < maxfit2DGInd)]), $
        MIN(fit2DG.fitparams[2,(fit2DInds < maxfit2DGInd)]), $
        MIN(fit2DG.fitparams[3,(fit2DInds < maxfit2DGInd)])
  ;; PRINT,FORMAT='(A0,T30,F-8.1,T40,F-8.1,T50,F-8.3,T60,F-8.4,T70,F-8.1,T80,F-8.1,T90,I-8,T100,F-8.4)', $
  PRINT,FORMAT='(A0,T30,F-8.1,T40,F-8.1,T50,F-8.1,T60,F-8.3,T70,F-8.4,T80,F-8.1,T90,F-8.1,T100,I-8,T110,F-8.4)', $
        "MAX", $
        MAX(jvPlotData.pot[(jvPlotInds < maxJVPlotInd)]), $
        MAX(fit2DK.fitparams[0,(fit2DInds < maxfit2DKInd)]), $
        MAX(fit2DK.fitparams[1,(fit2DInds < maxfit2DKInd)]), $
        MAX(fit2DK.fitparams[2,(fit2DInds < maxfit2DKInd)]), $
        MAX(fit2DK.fitparams[3,(fit2DInds < maxfit2DKInd)]), $
        MAX(fit2DG.fitparams[0,(fit2DInds < maxfit2DGInd)]), $
        MAX(fit2DG.fitparams[1,(fit2DInds < maxfit2DGInd)]), $
        MAX(fit2DG.fitparams[2,(fit2DInds < maxfit2DGInd)]), $
        MAX(fit2DG.fitparams[3,(fit2DInds < maxfit2DGInd)])
