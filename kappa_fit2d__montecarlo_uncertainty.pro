...
PRO KAPPA_FIT2D__MONTECARLO_UNCERTAINTY,data,Pkappa,Pgauss,Pobs, $
                                        NROLLS=nRolls, $
  ...
  data_gaussError = RANDOMN(seed__data_error,data.NEnergy,data.NBins,Nsim)
  error_gaussEror = RANDOMN(seed__error_error,data.NEnergy,data.NBins,Nsim)
  ...
  FOR k=0,Nsim-1 DO BEGIN
     ...
     KAPPA_FIT2D__HORSESHOE,keepK_iTime,iTime, $
                            out_eRange_peak, $
                            nEnergies, $
                            nTotAngles, $
                            successes, $
