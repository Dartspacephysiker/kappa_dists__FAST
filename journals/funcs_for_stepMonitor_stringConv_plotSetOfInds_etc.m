...
(* ::Input::Initialization:: *)
tPlotInds[inds_,mom_,momErr_,pRange_,xTitle_,yTitle_]:=ErrorListPlot[(makeErrorData[pots[[#]],mom[[#]],momErr[[#]]])&[inds],AxesStyle->(FontSize->24),PlotRange->pRange,Epilog->Style[Text[StringJoin@Riffle[time[[{inds[[1]],inds[[-1]]}]],"\[Dash]"],Scaled[{0.05,0.95}],{-1,1}],24],ImageSize->600,Frame->True,FrameLabel->{xTitle,yTitle},FrameStyle->Directive[Black,15]]


(* ::Input::Initialization:: *)
tPlotRange[ind1_,ind2_,mom_,momErr_,pRange_,xTitle_,yTitle_]:=ErrorListPlot[(makeErrorData[pots[[#1;;#2]],mom[[#1;;#2]],momErr[[#1;;#2]]])&[ind1,ind2],AxesStyle->(FontSize->24),PlotRange->pRange,Epilog->Style[Text[StringJoin@Riffle[time[[{ind1,ind2}]],"\[Dash]"],Scaled[{0.05,0.95}],{-1,1}],24],ImageSize->600,Frame->True,FrameLabel->{xTitle,yTitle},FrameStyle->Directive[Black,15]]
