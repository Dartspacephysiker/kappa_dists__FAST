...
PRO JOURNAL__20180808__BOOTSTRAP_ORB_1607_2D_DISTS_TO_GET_BESTFIT_PARAM_ERRORS, $
  ...
  fil = '20180808-orb_1607-KandGfits-ees-2NDKAPPA-only_fit_peak_eRange-sRate1_89-01_03_50__000-01_06_15__000.sav'

  diff_eFlux_dir = '/SPENCEdata/software/sdt/batch_jobs/saves_output_etc/diff_eFlux/'
  diff_eFlux_fil = 'orb_1607-diff_eflux-ees-sRate1_89-01_03_50__000-01_06_15__000.sav'
  ...
  IF arrDiffE THEN BEGIN
     badObsSynth_i   = WHERE(ABS((diff_eFlux[diff_eFlux_inds].time-offset)-tid) GT 0.05,nBadObsSynth)
  ENDIF ELSE BEGIN
  ...
  ;; Now get obs structs
  IF arrDiffE THEN BEGIN
     obsStructArr = TEMPORARY(diff_eFlux)
  ENDIF ELSE BEGIN
